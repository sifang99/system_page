 ...
 <div class="clearfix">
  <el-table :data="attention" style="width: 100%" :row-class-name="getReceiveAttention" >
    <el-table-column  label="" width="80" >
      <!-- <el-checkbox v-model="checked" :checked="checked" @change="checked($event)"></el-checkbox> -->
      <el-checkbox v-model="checked" style="padding-right=100%"></el-checkbox>
    </el-table-column>
  ...
  <el-button type="success" round id="btn-del">删除</el-button>
 </div>
</template>

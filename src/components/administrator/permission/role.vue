    ...
    <div>
        ...
        <el-table :data="selectrolelists.slice((currentPage-1)*pageSize,currentPage*pageSize)"
            ...
            <el-table-column prop="operation" label="角色管理" align="center">
                ...
                <el-button type="primary" icon="el-icon-edit-outline" round id="btn-edit" @click="GethavaPermissionDialog()">查看权限</el-button>
            </el-table-column>
        </el-table>
        ...
        <el-dialog title="查看权限" :visible.sync="getpermissionVisible">
            <el-table :data="havepermissionlists" style="width: 120%" border="true">
                <el-table-column label="选择" align="center" width="80">
                    <el-checkbox v-model="checkdelpermission"></el-checkbox>
                </el-table-column>
                <el-table-column prop="id" label="序号" align="center" width="50"></el-table-column>
                <el-table-column prop="pname" label="权限名称" align="center"></el-table-column>
                <el-table-column prop="pcode" label="权限映射" align="center"></el-table-column>
        ...
        <div slot="footer" class="dialog-footer">
            <el-button @click="editVisible = false">取 消</el-button>
            <el-button type="danger" icon="el-icon-delete" round @click="delVisible = true">删 除</el-button>
        </div>
        </el-dialog>
...
export default {
  ...
  data () {
    return {
      ...
      getpermissionVisible: false, // 显示查看角色的权限列表
      delVisible: false, // 显示删除权限对话框

      // checkdelpermission: true,
  ...
  methods: {
    ...
    // 打开查看角色权限的信息框
    GethavaPermissionDialog () {
      this.getpermissionVisible = true
      // 需要初始化角色拥有的权限列表havaperimissionlists
    },
